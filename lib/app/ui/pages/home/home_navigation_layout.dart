                    ...
                    onGenerateRoute: (RouteSettings settings) {
                      ...
                      switch (settings.name) {
                        ...
                        case Routes.POPULAR_VIDEOS:
                          builder = (BuildContext context) => const PopularVideoListPage();
                        ...
                        case Routes.SUBSCRIPTIONS:
                          builder = (BuildContext context) => const Center(child: Text('订阅'));
                          route = PageRouteBuilder(
                            pageBuilder: (context, animation, secondaryAnimation) => builder(context),
                            settings: settings,
                            transitionDuration: Duration.zero,
...
class HomeNavigatorObserver extends NavigatorObserver {
  ...
  void didPush(Route route, Route? previousRoute) {
    print('[导航栏] didPush ${route.settings.name}， 当前的路由数量: ${routes.length}, 当前的routes: $routes');
  ...
  void didReplace({Route? newRoute, Route? oldRoute}) {
    print('[导航栏] didReplace ${oldRoute?.settings.name} -> ${newRoute?.settings.name}');
