...
class _ThreadListPageState extends State<ThreadListPage> with SingleTickerProviderStateMixin {
      ...
      appBar: AppBar(
        ...
        actions: [
          Obx(() => IconButton(
            ...
            onPressed: () => _enableFloatingButton.value = !_enableFloatingButton.value,
  ...
  Widget buildItem(BuildContext context, ForumThreadModel thread, int index) {
    return Card(
                    ...
                    child: Column(
                      ...
                      children: [
                        GestureDetector(
                          ...
                          child: _buildUserName(thread.user),
                        ),
                        Text(
                      ...
                      child: Column(
                        ...
                        children: [
                          GestureDetector(
                            ...
                            child: _buildUserName(thread.lastPost!.user),
                          ),
                          Text(
